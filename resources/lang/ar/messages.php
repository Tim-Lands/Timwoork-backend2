...
return [
    ...
    "validation" => [
        ...
        "title_size" => "العنوان لا يقل عن 20 حرف و لا يكون اكبر من 60 حرف",
        "title_required" => "عنوان الخدمة مطلوب",
        ...
        "portfolio_details_required" => "تفاصيل العمل مطلوبة",
    ...
    'cover_required'=>'يجب ارفاق خلفية لمعرض الاعمال',
        ...
        "price_between" => "يجب أن يكون السعر بين 5 دولار و 1000 دولار",
        ...
        'portfolio_details_min'=>"يجب أن لا يقل تفاصيل العمل عن 30 حرف",
        ...
        "phone_regex" => "يجب أن يحتوي رقم الهاتف على أرقام",
        "phone_max" => "يجب أن يحتوي رقم الهاتف على اقل 8 أرقام",
        "phone_min" => "يجب أن يحتوي رقم الهاتف على اكثر 16 أرقام",
        'phone_number_numeric' => 'يجب أن يحتوي رقم الهاتف على أرقام',
        'code_phone_required' => 'يجب عليك إدخال كود الهاتف لدولتك',
        'phone_digits_between'=>'يجب أن يكون رقم الهاتف يتراوح بين 4 و16 رقم',
        'username_regex' => 'يجب ان يحتوي اسم المستخدم على حروف و ارقام فقط',
        'is_tutorial_boolean'=>'يجب ان تكون قيمة ذاك الحقل على هيئة بوليانية',
        'repeating_type_in'=>'يجب ان تكون قيمة الحقل DAILT, WEEKLY, or MONTHLY',
    ],
    ...
    "user" => [
        ...
        "unban_success" => "تم إلغاء حظر المستخدم بنجاح",
    ],
    // البائع
    "seller" => [
    ...
    "product" => [
        ...
        "thumbnail_required" => "يجب عليك رفع الصورة الأمامية",
        "galaries_required" => "يجب عليك رفع صورة عرض",
        "cause_required" => "يجب عليك إدخال سبب الرفض",
        "accepted_product" => "هذه الخدمة تم قبولها من قبل",
        "rejected_product" => "هذه الخدمة تم رفضها من قبل"
    ],
    ...
    "errors" => [
        ...
        "upload_images" => "يجب عليك رفع الصور",
        "too_many_attempts" => "لقد تم تجاوز عدد محاولاتك المسموح بها, انتظر دقيقة حتى تستطيع تكرار العملية",
        "too_many_attempts_send_code" => "لقد تم تجاوز عدد محاولاتك في ارسال الكود, انتظر دقيقة حتى تستطيع تكرار العملية",
        "meeting_not_complete"=>"لا يمكن نشر الخدمة حيث معلومات الحصة ليست كاملة "
